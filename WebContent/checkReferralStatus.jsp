...
<body bgcolor="#87CEEB">
	...
	String jobcode=j.getJobcode();%>
		<h3 align="center">Referral status ::</h3>
		<table align="center">
			<tr>
			...
			<%
				...
				ArrayList<Referral> sp1 = (ArrayList<Referral>) session.getAttribute("listOfBuddy");
		...
		<center>
		<button class="button" style="vertical-align:middle"  type="submit"><span>Edit </span></button>
