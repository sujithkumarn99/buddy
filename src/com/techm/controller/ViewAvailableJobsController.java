...
/**
 * Servlet implementation class ViewAvailableJobsController
 */
public class ViewAvailableJobsController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewAvailableJobsController() {
        super();
