...
/**
 * Servlet implementation class SpocViewAndDeleteJobsController
 */
public class SpocViewAndDeleteJobsController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SpocViewAndDeleteJobsController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request
				.getRequestDispatcher("/spocDeleteJobs.jsp");
